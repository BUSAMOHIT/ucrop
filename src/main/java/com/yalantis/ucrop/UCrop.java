...
public class UCrop {
     ...
     * Send the crop Intent from an Activity with a custom request code
     *
     * @param activity    Free crop Activity to receive result
     * @param requestCode requestCode for result
     */
    public void startFreeCrop(@NonNull Activity activity, int requestCode) {
        activity.startActivityForResult(getFreeCropIntent(activity), requestCode);
    }
...
//    }
    ...
    /**
     * Get Intent to start {@link UCropFreeActivity}
     *
     * @return Intent for {@link UCropFreeActivity}
     */
    public Intent getFreeCropIntent(@NonNull Context context) {
        mCropIntent.setClass(context, UCropFreeActivity.class);
        mCropIntent.putExtras(mCropOptionsBundle);
        return mCropIntent;
    }
    ...
    public static class Options {
        ...
        public static final String EXTRA_ROUND_CROP_ENABLED = EXTRA_PREFIX + ".IsRoundCrioEnabled";
        ...
        /**
         * @param errorCode - desired error code for activity
         */
        public void setErrorCode(@Nullable int errorCode) {
            mOptionBundle.putInt(EXTRA_ERROR, errorCode);
        }
        ...
        public void setExtraRoundCropEnabled(boolean isRoundCrop) {
            mOptionBundle.putBoolean(EXTRA_ROUND_CROP_ENABLED, isRoundCrop);
        }
