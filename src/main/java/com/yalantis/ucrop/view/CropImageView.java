...
public class CropImageView extends TransformImageView {
    ...
    private boolean isRoundCropEnabled = false;

    public void setRoundCropEnabled(boolean roundCropEnabled) {
        this.isRoundCropEnabled = roundCropEnabled;
    }
     ...
     */
    public void cropAndSaveImage(@NonNull Bitmap.CompressFormat compressFormat, int compressQuality, boolean isRoundCropEnabled, @Nullable BitmapCropCallback cropCallback) {
        cancelAllAnimations();
        ...
        new BitmapCropTask(getViewBitmap(), imageState, cropParameters, cropCallback,isRoundCropEnabled).execute();
    }
